...
final class CommandGetLabel: Command {
    ...
    func initCommand(_ transmitProtocolHandler: TransmitProtocolHandler) {
        ...
        message = LiFXMessage(messageType: LiFXMessage.MessageType.deviceGetLabel, sequenceNumber: sequenceNumber, sourceNumber: sourceNumber,targetAddress: (UInt8(0), UInt8(0), UInt8(0), UInt8(0), UInt8(0), UInt8(0), UInt8(0), UInt8(0)), messagePayload: nil)
    }
